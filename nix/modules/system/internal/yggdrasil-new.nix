# THIS IS A CLONE OF module from nixpkgs rev ad524718501f3fcd2ad76fcc189d7326269f5a1e
# WITH PATCHES TO BE SUCKLESS
{
  config,
  lib,
  pkgs,
...
in
{
  ...
  options = {
    services.yggdrasil = {
      ...
      # TODO: merge
      privateSetting = mkOption {
        type = nullOr path;
        default = null;
        example = "/run/secrets/yggdrasil-private.conf";
        description = ''
          Path to the private config part to be merged with.
        '';
      };
    };
  };
