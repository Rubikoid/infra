...
const downloadFileHttps = (fileName, url, expectedHash, hashType = 'sha1') => {
    return new Promise((resolve, reject) => {
        const get = (url, redirects = 0) => https.get(url, { timeout: 1 }, (res) => {
            console.warn(`Attempt to download ${url}: r=${redirects}`)
